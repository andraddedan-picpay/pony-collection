# 🎨 Pony Collection Theme

Design system com paleta de cores, tipografia e estilos visuais do projeto.
...
| Variável SCSS | Valor | Descrição |
|---------------|-------|-----------|
| `$primary-shadow` | `#E669EA80` | Sombra com cor primária (50% opacity) |
| `$base-shadow` | `#00000040` | Sombra padrão (25% opacity) |

---

## 👁️ Opacidade

| Variável SCSS | Valor | Percentual |
|---------------|-------|------------|
| `$opacity-60` | `0.60` | 60% |
| `$opacity-50` | `0.50` | 50% |
