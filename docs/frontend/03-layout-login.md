...
<div class="login-page">          <!-- Background image -->
  <div class="login-content">     <!-- Dark overlay (75% opacity) -->
    <div class="login-card">       <!-- White card with form -->
```
...
[(ngModel)]="email"  // ERRO: email é um signal, não uma string

// ✅ Funciona - Separa leitura e escrita
[ngModel]="email()"                   // Lê o valor
(ngModelChange)="updateEmail($event)" // Atualiza via método
```
